...
class GenerateCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addArgument('composer-json-path', InputOption::VALUE_OPTIONAL, 'Path to composer.json file. Assume pwd if not present.')
            ->addArgument('composer-lock-path', InputOption::VALUE_OPTIONAL, 'Path to composer.lock file. Assume pwd if not present.');
    }
